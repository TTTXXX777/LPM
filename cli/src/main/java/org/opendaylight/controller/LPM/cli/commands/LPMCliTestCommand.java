 ...
 */
package org.opendaylight.controller.LPM.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.opendaylight.controller.LPM.cli.api.LPMCliCommands;
...
public class LPMCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(LPMCliTestCommand.class);
    protected final LPMCliCommands service;

    public LPMCliTestCommand(final LPMCliCommands service) {
